...
export const metadata = {
  title: "VIP превью совместимости",
  description: "Короткое VIP превью. Без оплаты.",
};
    ...
    >
      <div className="aphrodite-scroll-safe aphrodite-safe-bottom mx-auto max-w-3xl space-y-4">
        <header className="mb-4 min-w-0">
          <h1 className="aphrodite-wrap-anywhere text-2xl font-bold text-slate-100">VIP превью совместимости</h1>

...
export const metadata: Metadata = {
  title: "Мистические числа",
  description: "Безопасный вход в актуальный Mini App mystic preview.",
};

export default function MysticNumbersPage() {
  return (
    <main
      data-aphrodite-package-275-public-mock-guard="mystic-numbers"
    ...
    >
      <section className="mx-auto flex min-h-[calc(100vh-48px)] max-w-md flex-col justify-center">
        <div className="rounded-lg border border-white/12 bg-white/[0.06] p-4 shadow-[0_20px_70px_rgba(8,13,30,0.35)]">
          ...
          <h1 className="mt-4 text-2xl font-semibold leading-8 text-white">Мистические числа</h1>

...
export default function VipPreviewPage() {
  return (
    <div
      ...
      className="aphrodite-mobile-shell zodiac-miniapp-safe-area flex flex-col bg-[#070b14] text-slate-100 font-sans"
    >
      <header className="sticky top-0 z-10 border-b border-fuchsia-900/50 bg-[#070b14]/80 px-3 py-3 backdrop-blur-md min-[390px]:px-4">
        <div className="mx-auto flex max-w-md items-center gap-3">
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            <h1 className="aphrodite-wrap-anywhere text-lg font-semibold text-slate-100">VIP Preview</h1>
          </div>
        </div>
      </header>
      ...
      <main className="aphrodite-scroll-safe aphrodite-safe-bottom mx-auto flex w-full max-w-md flex-1 flex-col px-3 py-5 min-[390px]:px-4 min-[390px]:py-6">
        ...
        <div className="mb-6 flex min-w-0 items-start gap-3 rounded-lg border border-amber-900/30 bg-amber-900/10 p-3 text-sm min-[390px]:p-4">
          ...
          <div className="min-w-0">
            <p className="aphrodite-wrap-anywhere font-semibold text-amber-500 text-base">Preview Only (Package 107)</p>
            <p className="aphrodite-wrap-anywhere mt-1 text-xs text-amber-400/80 mb-3">This is a static boundary. No payment logic or real VIP access is active.</p>
        ...
        <div className="mb-6 flex min-w-0 items-start gap-3 rounded-lg border border-indigo-900/30 bg-indigo-900/10 p-3 text-sm min-[390px]:p-4">
          ...
          <div className="min-w-0">
            <p className="aphrodite-wrap-anywhere font-medium text-indigo-300">VIP Access Boundary exists, but real VIP unlock is not active.</p>
        ...
        <div className="mb-6 flex min-w-0 items-start gap-3 rounded-lg border border-violet-900/30 bg-violet-900/10 p-3 text-sm min-[390px]:p-4">
          ...
          <div className="min-w-0">
            <p className="aphrodite-wrap-anywhere font-medium text-violet-300">VIP Compatibility Deep Report content foundation exists, but payment and real VIP unlock are not active.</p>
        ...
        <div className="space-y-8">
          <div className="text-center">
            ...
            <h2 className="aphrodite-wrap-anywhere text-2xl font-bold text-slate-100">Future VIP Access</h2>
            <p className="aphrodite-wrap-anywhere mt-2 text-sm text-slate-400">Preview the advanced features planned for future updates.</p>
          </div>
          ...
          <div className="min-w-0 rounded-lg border border-indigo-900/30 bg-indigo-900/10 p-3 min-[390px]:p-5">
            ...
            <ul className="grid grid-cols-1 gap-2 text-sm text-slate-300">
              <li className="aphrodite-wrap-anywhere flex items-center gap-2"><CreditCard className="h-4 w-4 text-indigo-500/70" /> Payment provider</li>
              <li className="aphrodite-wrap-anywhere flex items-center gap-2"><Database className="h-4 w-4 text-indigo-500/70" /> User profile storage</li>
              ...
              <li className="aphrodite-wrap-anywhere flex items-center gap-2"><FileText className="h-4 w-4 text-indigo-500/70" /> Privacy policy & Refund rules</li>

...
import { getAphroditeTelegramMiniappFinalPreManualSummary } from "@/lib/zodiac/aphrodite-telegram-miniapp-final-pre-manual-summary";

const model = getAphroditeTelegramMiniappFinalPreManualSummary();
...
export default function TelegramMiniappFinalPreManualSummaryPage() {
  return (

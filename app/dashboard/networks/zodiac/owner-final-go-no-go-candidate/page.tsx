...
import { getAphroditeOwnerFinalGoNoGoCandidate } from "@/lib/zodiac/aphrodite-owner-final-go-no-go-candidate";

const model = getAphroditeOwnerFinalGoNoGoCandidate();
...
export default function OwnerFinalGoNoGoCandidatePage() {
  return (

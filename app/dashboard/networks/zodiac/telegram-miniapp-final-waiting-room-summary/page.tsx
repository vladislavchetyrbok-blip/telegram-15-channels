...
import { getAphroditeTelegramMiniappFinalWaitingRoomSummary } from "@/lib/zodiac/aphrodite-telegram-miniapp-final-waiting-room-summary";

const model = getAphroditeTelegramMiniappFinalWaitingRoomSummary();
...
export default function TelegramMiniappFinalWaitingRoomSummaryPage() {
  return (

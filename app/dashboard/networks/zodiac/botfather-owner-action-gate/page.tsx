...
import { getAphroditeBotfatherOwnerActionGate } from "@/lib/zodiac/aphrodite-botfather-owner-action-gate";

const model = getAphroditeBotfatherOwnerActionGate();
...
export default function BotfatherOwnerActionGatePage() {
  return (

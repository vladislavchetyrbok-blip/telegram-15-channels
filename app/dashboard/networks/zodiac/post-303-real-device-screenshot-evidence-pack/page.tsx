...
import { getAphroditePost303RealDeviceScreenshotEvidencePack } from "@/lib/zodiac/aphrodite-post-303-real-device-screenshot-evidence-pack";

const model = getAphroditePost303RealDeviceScreenshotEvidencePack();
...
export default function Post303RealDeviceScreenshotEvidencePackPage() {
  return (

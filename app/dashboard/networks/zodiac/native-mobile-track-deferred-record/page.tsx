...
import { getAphroditeNativeMobileTrackDeferredRecord } from "@/lib/zodiac/aphrodite-native-mobile-track-deferred-record";

const model = getAphroditeNativeMobileTrackDeferredRecord();
...
export default function NativeMobileTrackDeferredRecordPage() {
  return (

...
import { getAphroditePublicUrlClosureCandidate } from "@/lib/zodiac/aphrodite-public-url-closure-candidate";

const model = getAphroditePublicUrlClosureCandidate();
...
export default function PublicUrlClosureCandidatePage() {
  return (

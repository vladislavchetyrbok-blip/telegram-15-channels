...
import { getAphroditeVipPreviewLockCopyConsistencyGate } from "@/lib/zodiac/aphrodite-vip-preview-lock-copy-consistency-gate";

const model = getAphroditeVipPreviewLockCopyConsistencyGate();
...
export default function VipPreviewLockCopyConsistencyGatePage() {
  return (

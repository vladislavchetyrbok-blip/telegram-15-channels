...
import { getAphroditeOneChannelSoftLaunchPlanCandidate } from "@/lib/zodiac/aphrodite-one-channel-soft-launch-plan-candidate";

const model = getAphroditeOneChannelSoftLaunchPlanCandidate();
...
export default function OneChannelSoftLaunchPlanCandidatePage() {
  return (

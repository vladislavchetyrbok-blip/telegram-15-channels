...
import { getAphroditePublicMiniappRouteVisualRegressionChecklist } from "@/lib/zodiac/aphrodite-public-miniapp-route-visual-regression-checklist";

const model = getAphroditePublicMiniappRouteVisualRegressionChecklist();
...
export default function PublicMiniappRouteVisualRegressionChecklistPage() {
  return (

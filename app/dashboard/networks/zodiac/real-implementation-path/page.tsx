    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      ...
      <section className="rounded-lg border border-slate-800 bg-slate-900/30 p-6 mt-8">
        ...
        <ul className="flex flex-wrap gap-4 text-sm">
          ...
          <li><Link href="/dashboard/networks/zodiac/aphrodite-product-remediation" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Aphrodite Product Remediation</Link></li>
          <li><Link href="/dashboard/networks/zodiac/first-result-experience" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">First Result Experience</Link></li>
          <li><Link href="/dashboard/networks/zodiac/ai-love-reading-foundation" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">AI Love Reading Foundation</Link></li>
          <li><Link href="/dashboard/networks/zodiac/soulmate-scanner-foundation" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Soulmate Scanner Foundation</Link></li>
          ...
          <li><Link href="/dashboard/networks/zodiac/social-draft-review-queue" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Social Draft Review Queue</Link></li>
          <li><Link href="/dashboard/networks/zodiac/social-export-dashboard" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Social Export Dashboard</Link></li>
          <li><Link href="/dashboard/networks/zodiac/social-content-calendar" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Social Content Calendar</Link></li>
          <li><Link href="/dashboard/networks/zodiac/public-bot-profile-launch-packaging" className="text-rose-400 hover:text-rose-300 transition underline underline-offset-4">Public Bot Launch Packaging</Link></li>
          ...
          <li><Link href="/dashboard/networks/zodiac/stars-payment-safety-review" className="text-emerald-400 hover:text-emerald-300 transition underline underline-offset-4">Stars Payment Safety Review</Link></li>
          <li><Link href="/dashboard/networks/zodiac/telegram-stars-invoice-draft" className="text-emerald-400 hover:text-emerald-300 transition underline underline-offset-4">Stars Invoice Draft</Link></li>
        </ul>
      </section>
    </div>
  );

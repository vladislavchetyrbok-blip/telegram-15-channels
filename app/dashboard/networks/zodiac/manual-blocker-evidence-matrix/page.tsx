...
import { getAphroditeManualBlockerEvidenceMatrix } from "@/lib/zodiac/aphrodite-manual-blocker-evidence-matrix";

const model = getAphroditeManualBlockerEvidenceMatrix();
...
export default function ManualBlockerEvidenceMatrixPage() {
  return (

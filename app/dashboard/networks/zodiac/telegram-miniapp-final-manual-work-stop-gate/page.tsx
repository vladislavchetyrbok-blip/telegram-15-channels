...
import { getAphroditeTelegramMiniappFinalManualWorkStopGate } from "@/lib/zodiac/aphrodite-telegram-miniapp-final-manual-work-stop-gate";

const model = getAphroditeTelegramMiniappFinalManualWorkStopGate();
...
export default function TelegramMiniappFinalManualWorkStopGatePage() {
  return (

...
import { getAphroditeMobileResultDensityGuardrails } from "@/lib/zodiac/aphrodite-mobile-result-density-guardrails";

const model = getAphroditeMobileResultDensityGuardrails();
...
export default function MobileResultDensityGuardrailsPage() {
  return (

...
import { getAphroditeInputControlsFinalOwnerReviewGate } from "@/lib/zodiac/aphrodite-input-controls-final-owner-review-gate";

const model = getAphroditeInputControlsFinalOwnerReviewGate();
...
export default function InputControlsFinalOwnerReviewGatePage() {
  return (

...
import { getAphroditeFreshBackupClosureCandidate } from "@/lib/zodiac/aphrodite-fresh-backup-closure-candidate";

const model = getAphroditeFreshBackupClosureCandidate();
...
export default function FreshBackupClosureCandidatePage() {
  return (

...
import { getAphroditeRealDeviceOwnerApprovalDecisionRecord } from "@/lib/zodiac/aphrodite-real-device-owner-approval-decision-record";

const model = getAphroditeRealDeviceOwnerApprovalDecisionRecord();
...
export default function RealDeviceOwnerApprovalDecisionRecordPage() {
  return (

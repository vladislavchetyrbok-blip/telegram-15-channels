...
import { getAphroditeRedactedEnvClosureOwnerActionGate } from "@/lib/zodiac/aphrodite-redacted-env-closure-owner-action-gate";

const model = getAphroditeRedactedEnvClosureOwnerActionGate();
...
export default function RedactedEnvClosureOwnerActionGatePage() {
  return (

...
import { getAphroditeFinalManualWorkQueue } from "@/lib/zodiac/aphrodite-final-manual-work-queue";

const model = getAphroditeFinalManualWorkQueue();
...
export default function FinalManualWorkQueuePage() {
  return (

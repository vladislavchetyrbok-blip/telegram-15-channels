...
import { getAphroditeFinalPreLaunchEvidenceBinder } from "@/lib/zodiac/aphrodite-final-pre-launch-evidence-binder";

const model = getAphroditeFinalPreLaunchEvidenceBinder();
...
export default function FinalPreLaunchEvidenceBinderPage() {
  return (

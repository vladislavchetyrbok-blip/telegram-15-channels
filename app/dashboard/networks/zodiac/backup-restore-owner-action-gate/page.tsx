...
import { getAphroditeBackupRestoreOwnerActionGate } from "@/lib/zodiac/aphrodite-backup-restore-owner-action-gate";

const model = getAphroditeBackupRestoreOwnerActionGate();
...
export default function BackupRestoreOwnerActionGatePage() {
  return (

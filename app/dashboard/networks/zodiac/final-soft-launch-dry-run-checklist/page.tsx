...
import { getAphroditeFinalSoftLaunchDryRunChecklist } from "@/lib/zodiac/aphrodite-final-soft-launch-dry-run-checklist";

const model = getAphroditeFinalSoftLaunchDryRunChecklist();
...
export default function FinalSoftLaunchDryRunChecklistPage() {
  return (

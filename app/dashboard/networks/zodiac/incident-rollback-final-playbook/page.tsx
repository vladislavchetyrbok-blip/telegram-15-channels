...
import { getAphroditeIncidentRollbackFinalPlaybook } from "@/lib/zodiac/aphrodite-incident-rollback-final-playbook";

const model = getAphroditeIncidentRollbackFinalPlaybook();
...
export default function IncidentRollbackFinalPlaybookPage() {
  return (

...
import { getAphroditeFinalNoMoreReadinessPackagesGate } from "@/lib/zodiac/aphrodite-final-no-more-readiness-packages-gate";

const model = getAphroditeFinalNoMoreReadinessPackagesGate();
...
export default function FinalNoMoreReadinessPackagesGatePage() {
  return (

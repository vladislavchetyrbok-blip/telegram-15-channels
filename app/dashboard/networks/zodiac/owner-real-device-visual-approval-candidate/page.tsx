...
import { getAphroditeOwnerRealDeviceVisualApprovalCandidate } from "@/lib/zodiac/aphrodite-owner-real-device-visual-approval-candidate";

const model = getAphroditeOwnerRealDeviceVisualApprovalCandidate();
...
export default function OwnerRealDeviceVisualApprovalCandidatePage() {
  return (

...
const platformSections = [
  ...
  },
  {
    ...
    href: "/dashboard/networks/zodiac/owner-real-device-evidence-intake",
    icon: Smartphone,
    caption: "Package 293 - owner screenshots are still pending; real-device approval remains false.",
    tone: "amber",
  },
  {
    title: "Redacted Env Presence Gate",
    href: "/dashboard/networks/zodiac/redacted-env-presence-verification-gate",
    icon: ShieldCheck,
    caption: "Package 294 - DATABASE_URL and TELEGRAM_BOT_TOKEN presence remains missing or not verified, with redacted evidence only.",
    tone: "rose",
  },
  {
    title: "Backup Refresh Evidence Intake",
    href: "/dashboard/networks/zodiac/backup-refresh-evidence-intake",
    icon: Database,
    caption: "Package 295 - fresh backup evidence is pending; backup is stale or unverified.",
    tone: "rose",
  },
  {
    title: "Restore Rehearsal Evidence Intake",
    href: "/dashboard/networks/zodiac/restore-rehearsal-evidence-intake",
    icon: GitBranch,
    caption: "Package 296 - manual restore rehearsal evidence is required and not completed.",
    tone: "rose",
  },
  {
    title: "Public URL Evidence Intake",
    href: "/dashboard/networks/zodiac/public-url-evidence-intake",
    icon: Share2,
    caption: "Package 297 - PUBLIC_APP_URL and route evidence remain missing or not verified.",
    tone: "rose",
  },
  {
    title: "BotFather Manual Setup Evidence Intake",
    href: "/dashboard/networks/zodiac/botfather-manual-setup-evidence-intake",
    icon: Bot,
    caption: "Package 298 - BotFather Mini App URL setup remains manual and not done.",
    tone: "rose",
  },
  {
    title: "Final Production Safety Recheck Gate",
    href: "/dashboard/networks/zodiac/final-production-safety-recheck-gate",
    icon: ShieldCheck,
    caption: "Package 299 - final production safety remains blocked by expected manual blockers.",
    tone: "rose",
  },
  {
    title: "Soft Launch Candidate Go No-Go Record",
    href: "/dashboard/networks/zodiac/soft-launch-candidate-go-no-go-record",
    icon: ClipboardCheck,
    caption: "Package 300 - soft launch decision is NO-GO until blockers close with evidence.",
    tone: "rose",
  },
  {
    title: "Post-Blocker Closure Final Launch Runbook Draft",
    href: "/dashboard/networks/zodiac/post-blocker-closure-final-launch-runbook-draft",
    icon: ListPlus,
    caption: "Package 301 - final launch runbook is blocked until manual gates close.",
    tone: "amber",
  },
  {
    title: "Manual Evidence Readiness Summary",
    href: "/dashboard/networks/zodiac/manual-evidence-readiness-summary",
    icon: FileText,
  ...
  },
  {
    ...
    href: "/dashboard/networks/zodiac/post-303-real-device-screenshot-evidence-pack",
    icon: Camera,
    caption: "Package 304 - Prepare a screenshot evidence pack checklist after Package 303 without fabricating screenshots or marking owner evidence received.",
    tone: "amber",
  },
  {
    title: "VIP Preview Lock and Copy Consistency Gate",
    href: "/dashboard/networks/zodiac/vip-preview-lock-copy-consistency-gate",
    icon: LockKeyhole,
    caption: "Package 305 - Document and verify that VIP wording remains consistent after Package 303 and never implies active payment or unlocked access.",
    tone: "amber",
  },
  {
    title: "Mobile Result Density Guardrails",
    href: "/dashboard/networks/zodiac/mobile-result-density-guardrails",
    icon: Smartphone,
    caption: "Package 306 - Create design and content guardrails to prevent future wall-of-text result screens on mobile Telegram WebView.",
    tone: "amber",
  },
  {
    title: "Public Mini App Route Visual Regression Checklist",
    href: "/dashboard/networks/zodiac/public-miniapp-route-visual-regression-checklist",
    icon: ClipboardCheck,
    caption: "Package 307 - Consolidate visual regression checks for all public Mini App routes after Package 303.",
    tone: "amber",
  },
  {
    title: "Input Controls Final Owner Review Gate",
    href: "/dashboard/networks/zodiac/input-controls-final-owner-review-gate",
    icon: MousePointerClick,
    caption: "Package 308 - Finalize owner review criteria for date, time, and city inputs without saving raw personal data or writing to DB.",
    tone: "amber",
  },
  {
    title: "Real Device Owner Approval Decision Record",
    href: "/dashboard/networks/zodiac/real-device-owner-approval-decision-record",
    icon: CheckCircle2,
    caption: "Package 309 - Create a decision record for owner approval while keeping approval pending until owner explicitly provides real evidence and go/no-go.",
    tone: "amber",
  },
  {
    title: "Manual Blocker Evidence Matrix",
    href: "/dashboard/networks/zodiac/manual-blocker-evidence-matrix",
    icon: FileText,
    caption: "Package 310 - Create one matrix for all manual blockers and evidence requirements, keeping every blocker open unless real evidence exists.",
    tone: "amber",
  },
  {
    title: "Pre-Soft-Launch No-Go Enforcement Record",
    href: "/dashboard/networks/zodiac/pre-soft-launch-no-go-enforcement-record",
    icon: ShieldCheck,
    caption: "Package 311 - Record that the project is still NO-GO for soft launch until manual blockers close.",
    tone: "amber",
  },
  {
    title: "Native iPhone Android Future Roadmap Draft",
    href: "/dashboard/networks/zodiac/native-ios-android-future-roadmap-draft",
    icon: GitBranch,
    caption: "Package 312 - Draft a future native iPhone/Android roadmap after Telegram Mini App stabilization, without adding native app code or store actions now.",
    tone: "amber",
  },
  {
    title: "Post-303 Final Readiness Summary",
    href: "/dashboard/networks/zodiac/post-303-final-readiness-summary",
    icon: ListPlus,

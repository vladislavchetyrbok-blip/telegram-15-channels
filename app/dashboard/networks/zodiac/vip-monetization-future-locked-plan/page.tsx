...
import { getAphroditeVipMonetizationFutureLockedPlan } from "@/lib/zodiac/aphrodite-vip-monetization-future-locked-plan";

const model = getAphroditeVipMonetizationFutureLockedPlan();
...
export default function VipMonetizationFutureLockedPlanPage() {
  return (

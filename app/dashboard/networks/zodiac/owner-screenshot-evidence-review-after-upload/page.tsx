...
import { getAphroditeOwnerScreenshotEvidenceReviewAfterUpload } from "@/lib/zodiac/aphrodite-owner-screenshot-evidence-review-after-upload";

const model = getAphroditeOwnerScreenshotEvidenceReviewAfterUpload();
...
export default function OwnerScreenshotEvidenceReviewAfterUploadPage() {
  return (

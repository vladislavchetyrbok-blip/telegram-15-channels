...
import { getAphroditeSoftLaunchNotApprovedBannerRecord } from "@/lib/zodiac/aphrodite-soft-launch-not-approved-banner-record";

const model = getAphroditeSoftLaunchNotApprovedBannerRecord();
...
export default function SoftLaunchNotApprovedBannerRecordPage() {
  return (

...
import { getAphroditeProductionSafetyCheckGreenCandidate } from "@/lib/zodiac/aphrodite-production-safety-check-green-candidate";

const model = getAphroditeProductionSafetyCheckGreenCandidate();
...
export default function ProductionSafetyCheckGreenCandidatePage() {
  return (

...
import { getAphroditePreSoftLaunchNoGoEnforcementRecord } from "@/lib/zodiac/aphrodite-pre-soft-launch-no-go-enforcement-record";

const model = getAphroditePreSoftLaunchNoGoEnforcementRecord();
...
export default function PreSoftLaunchNoGoEnforcementRecordPage() {
  return (

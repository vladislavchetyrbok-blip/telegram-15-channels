...
import { getAphroditePost303FinalReadinessSummary } from "@/lib/zodiac/aphrodite-post-303-final-readiness-summary";

const model = getAphroditePost303FinalReadinessSummary();
...
export default function Post303FinalReadinessSummaryPage() {
  return (

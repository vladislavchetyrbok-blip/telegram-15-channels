...
import { getAphroditeFinalRealDeviceVisualAcceptancePendingRecord } from "@/lib/zodiac/aphrodite-final-real-device-visual-acceptance-pending-record";

const model = getAphroditeFinalRealDeviceVisualAcceptancePendingRecord();
...
export default function FinalRealDeviceVisualAcceptancePendingRecordPage() {
  return (

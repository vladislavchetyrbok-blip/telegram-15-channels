import { ChevronLeft, LockKeyhole, MessageSquareText, ShieldCheck } from "lucide-react";
          ...
          <div className="relative overflow-hidden rounded-lg border border-violet-100 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
              ...
              <div className="flex flex-wrap gap-3 lg:justify-end">
                ...
                <Link href="/dashboard/networks/zodiac/security" className="inline-flex w-fit items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm font-semibold text-amber-800 transition hover:border-amber-300 hover:bg-amber-100">

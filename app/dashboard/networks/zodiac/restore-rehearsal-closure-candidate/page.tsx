...
import { getAphroditeRestoreRehearsalClosureCandidate } from "@/lib/zodiac/aphrodite-restore-rehearsal-closure-candidate";

const model = getAphroditeRestoreRehearsalClosureCandidate();
...
export default function RestoreRehearsalClosureCandidatePage() {
  return (

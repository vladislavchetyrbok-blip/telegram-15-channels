...
import { getAphroditeProductionSafetyGreenCriteriaRecord } from "@/lib/zodiac/aphrodite-production-safety-green-criteria-record";

const model = getAphroditeProductionSafetyGreenCriteriaRecord();
...
export default function ProductionSafetyGreenCriteriaRecordPage() {
  return (

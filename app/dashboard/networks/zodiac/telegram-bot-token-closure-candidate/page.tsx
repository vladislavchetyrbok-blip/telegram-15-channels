...
import { getAphroditeTelegramBotTokenClosureCandidate } from "@/lib/zodiac/aphrodite-telegram-bot-token-closure-candidate";

const model = getAphroditeTelegramBotTokenClosureCandidate();
...
export default function TelegramBotTokenClosureCandidatePage() {
  return (

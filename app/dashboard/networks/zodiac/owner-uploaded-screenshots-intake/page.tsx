...
import { getAphroditeOwnerUploadedScreenshotsIntake } from "@/lib/zodiac/aphrodite-owner-uploaded-screenshots-intake";

const model = getAphroditeOwnerUploadedScreenshotsIntake();
...
export default function OwnerUploadedScreenshotsIntakePage() {
  return (

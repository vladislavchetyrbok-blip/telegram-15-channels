    ...
    <div className="space-y-6 text-slate-200">
      ...
      <div className="space-y-4 mt-8 pt-8 border-t border-slate-800">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 mt-3">
          ...
          <Link href="/dashboard/networks/zodiac/aphrodite-product-remediation" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-400" /> Aphrodite Remediation</div>
            <div className="text-xs text-slate-400">Product Remediation Plan</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/first-result-experience" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> First Result Experience</div>
            <div className="text-xs text-slate-400">Experience Rewrite</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/ai-love-reading-foundation" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> AI Love Reading</div>
            <div className="text-xs text-slate-400">Foundation</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/soulmate-scanner-foundation" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> Soulmate Scanner</div>
            <div className="text-xs text-slate-400">Foundation</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/red-flags-scanner-foundation" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> Red Flags Scanner</div>
            <div className="text-xs text-slate-400">Foundation</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/ai-future-timeline-foundation" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> AI Future Timeline</div>
            <div className="text-xs text-slate-400">Foundation</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/social-traffic-layer" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> Social Traffic Layer</div>
            <div className="text-xs text-slate-400">Architecture</div>
          </Link>
          <Link href="/dashboard/networks/zodiac/social-content-template-engine" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
          ...
          <Link href="/dashboard/networks/zodiac/social-export-dashboard" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
          ...
          <Link href="/dashboard/networks/zodiac/public-bot-profile-launch-packaging" className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 hover:bg-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white mb-1"><Activity className="h-4 w-4 text-rose-300" /> Public Bot Launch Packaging</div>
            <div className="text-xs text-slate-400">Manual setup</div>
          </Link>

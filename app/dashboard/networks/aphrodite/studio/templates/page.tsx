    ...
    <div className="-mx-4 -my-6 min-h-screen overflow-x-hidden bg-[#070b14] px-4 py-6 text-slate-100 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a href="/dashboard/networks/aphrodite/studio/briefs" className="rounded-lg bg-indigo-500/20 border border-indigo-500/30 px-4 py-2 text-sm font-medium text-indigo-300 hover:bg-indigo-500/30 transition">Брифы</a>
          <a href="/dashboard/networks/aphrodite/studio/queue" className="rounded-lg bg-emerald-500/20 px-4 py-2 text-sm font-medium text-emerald-300 hover:bg-emerald-500/30 transition border border-emerald-500/30">Очередь (Kanban)</a>
        </div>

...
const ROUTES = {
  ...
  ownerRealDeviceEvidenceIntake: "/dashboard/networks/zodiac/owner-real-device-evidence-intake",
  redactedEnvPresenceVerificationGate: "/dashboard/networks/zodiac/redacted-env-presence-verification-gate",
  backupRefreshEvidenceIntake: "/dashboard/networks/zodiac/backup-refresh-evidence-intake",
  restoreRehearsalEvidenceIntake: "/dashboard/networks/zodiac/restore-rehearsal-evidence-intake",
  publicUrlEvidenceIntake: "/dashboard/networks/zodiac/public-url-evidence-intake",
  botFatherManualSetupEvidenceIntake: "/dashboard/networks/zodiac/botfather-manual-setup-evidence-intake",
  finalProductionSafetyRecheckGate: "/dashboard/networks/zodiac/final-production-safety-recheck-gate",
  ...
  post303RealDeviceScreenshotEvidencePack: "/dashboard/networks/zodiac/post-303-real-device-screenshot-evidence-pack",
  vipPreviewLockCopyConsistencyGate: "/dashboard/networks/zodiac/vip-preview-lock-copy-consistency-gate",
  mobileResultDensityGuardrails: "/dashboard/networks/zodiac/mobile-result-density-guardrails",
  publicMiniappRouteVisualRegressionChecklist: "/dashboard/networks/zodiac/public-miniapp-route-visual-regression-checklist",
  inputControlsFinalOwnerReviewGate: "/dashboard/networks/zodiac/input-controls-final-owner-review-gate",
  realDeviceOwnerApprovalDecisionRecord: "/dashboard/networks/zodiac/real-device-owner-approval-decision-record",
  manualBlockerEvidenceMatrix: "/dashboard/networks/zodiac/manual-blocker-evidence-matrix",
...
async function main() {
  ...
  try {
    ...
    assertIncludes(pages.overview, 'href="/dashboard/networks/zodiac/production-blocker-closure-checklist"', "production blocker closure checklist route link");
    ...
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Content CTA Owner Review Execution", "content cta owner review execution title");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "BROWSER VERIFIED", "content cta browser verified");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Home CTA", "content cta home");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Compatibility CTA", "content cta compatibility execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Birth Matrix / Natal CTA", "content cta birth matrix natal execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Mystic Cards CTA", "content cta mystic execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "VIP Preview CTA", "content cta vip preview execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Result / Share Cards", "content cta result share execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Telegram startapp links", "content cta telegram startapp execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "dashboard/readiness links", "content cta dashboard readiness execution");
    assertIncludes(pages.contentCtaOwnerReviewExecution, "Owner content approval", "content cta owner approval execution");
    ...
    assertIncludes(pages.limitedSoftLaunchDryRunMatrix, "Limited Soft Launch Dry Run Matrix", "limited soft launch dry run title");
    assertIncludes(pages.limitedSoftLaunchDryRunMatrix, "dry-run only", "limited soft launch dry run only");
    assertIncludes(pages.limitedSoftLaunchDryRunMatrix, "No production launch was performed", "limited soft launch no production launch");
    ...
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "Soft Launch Monitoring Readiness Plan", "soft launch monitoring title");
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "monitoring plan", "soft launch monitoring plan");
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "manual monitoring only", "soft launch monitoring manual only");
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "no external analytics", "soft launch monitoring no analytics");
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "no production monitoring activation", "soft launch monitoring no production activation");
    assertIncludes(pages.softLaunchMonitoringReadinessPlan, "Package 262 - Incident Rollback Response Drill", "soft launch monitoring next package");
    assertIncludes(pages.incidentRollbackResponseDrill, "Incident Rollback Response Drill", "incident rollback title");
    assertIncludes(pages.incidentRollbackResponseDrill, "incident rollback response drill", "incident rollback section");
    assertIncludes(pages.incidentRollbackResponseDrill, "rollback drill only", "incident rollback drill only");
    ...
    assertIncludes(pages.manualChecklistOnePageRunbook, "Manual Checklist One-Page Runbook", "manual checklist one page runbook title");
    assertIncludes(pages.manualChecklistOnePageRunbook, "one-page runbook", "manual checklist one page runbook section");
    assertIncludes(pages.manualChecklistOnePageRunbook, "manual checklist", "manual checklist marker");
    ...
    assertIncludes(pages.finalPreOwnerReviewSummary, "Final Pre-Owner-Review Summary", "final pre owner review summary title");
    assertIncludes(pages.finalPreOwnerReviewSummary, "READY FOR OWNER REVIEW", "final pre owner review ready status");

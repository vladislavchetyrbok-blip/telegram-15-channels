...
const requiredCoverage = {
  ...
  lunarRitual: ["lunar_ritual_opened", "lunar_started", "lunar_day_calculated", "lunar_ritual_calculated", "lunar_ritual_saved", "lunar_ritual_shared", "feature_depth_viewed"],

...
async function runEnabledMode() {
  ...
  await withServer(
    ...
    async () => {
      ...
      assertIncludes(login.body, "Вход в Telegram Platform Dashboard", "enabled login page heading");
      ...
      assertIncludes(authorized.body, "Обзор управления Zodiac", "authorized dashboard content");

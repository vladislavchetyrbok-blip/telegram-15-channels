...
const endpoint = `${baseUrl.replace(/\/$/, "")}/api/admin/reports/send-daily-now`;
...
main().catch((error) => {
  console.error(`Autopilot report failed: ${error instanceof Error ? error.message : String(error)}`);

...
check("в scripts изменены только Package 158 QA и dashboard QA", scriptChanges.every((file) =>
  file === "scripts/qa-aphrodite-vip-access-guard-skeleton.mjs" || file === "scripts/qa-zodiac-dashboard.mjs",
));

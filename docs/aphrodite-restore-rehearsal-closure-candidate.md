...
Status field: `restoreRehearsalClosureStatus`  
Status value: `NOT_CLOSED_NOT_COMPLETED`
...
- restore rehearsal required: NOT_CLOSED_NOT_COMPLETED. restore rehearsal required is required before this gate can close. This package records the requirement only. Owner action: Provide real owner/manual evidence later.
- no production DB mutation: NOT_CLOSED_NOT_COMPLETED. no production DB mutation is required before this gate can close. This package records the requirement only. Owner action: Provide real owner/manual evidence later.

## blocked safety boundary

- evidence required: NOT_CLOSED_NOT_COMPLETED. evidence required remains blocked or future-only until owner/manual evidence exists. Owner action: Do not mark this complete automatically.
- rollback confidence requirement: NOT_CLOSED_NOT_COMPLETED. rollback confidence requirement remains blocked or future-only until owner/manual evidence exists. Owner action: Do not mark this complete automatically.

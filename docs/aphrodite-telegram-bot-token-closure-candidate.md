...
Status field: `telegramBotTokenClosureStatus`  
...
- no token printed: NOT_CLOSED_MISSING_OR_UNVERIFIED. no token printed is required before this gate can close. This package records the requirement only. Owner action: Provide real owner/manual evidence later.
- no Telegram API validation call: NOT_CLOSED_MISSING_OR_UNVERIFIED. no Telegram API validation call is required before this gate can close. This package records the requirement only. Owner action: Provide real owner/manual evidence later.

## blocked safety boundary

- no messages sent: LOCKED. no messages sent remains blocked or future-only until owner/manual evidence exists. Owner action: Do not mark this complete automatically.
- no BotFather changes: LOCKED. no BotFather changes remains blocked or future-only until owner/manual evidence exists. Owner action: Do not mark this complete automatically.

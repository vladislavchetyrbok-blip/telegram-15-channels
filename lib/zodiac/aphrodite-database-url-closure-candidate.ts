export type AphroditeDatabaseUrlClosureCandidateRow = {
  area: string;
  status: string;
  detail: string;
  ownerAction: string;
...
export const APHRODITE_DATABASE_URL_CLOSURE_CANDIDATE_TITLE = "DATABASE_URL Closure Candidate";

export const APHRODITE_DATABASE_URL_CLOSURE_CANDIDATE_ROUTE =
  "/dashboard/networks/zodiac/database-url-closure-candidate" as const;

export const aphroditeDatabaseUrlClosureCandidate = {
  "packageNumber": 337,
  ...
  "databaseUrlClosureStatus": "NOT_CLOSED_MISSING_OR_UNVERIFIED",
  ...
  "goal": "Document database_url closure candidate for Telegram Mini App manual evidence gates without closing blockers, faking evidence, launching production, calling Telegram, changing BotFather, adding payment/VIP unlock, writing to DB, changing workflows, touching apps/mobile, or adding secrets.",
  "sections": [
    {
      ...
      "rows": [
        ...
        {
          "area": "no value printed",
          "status": "NOT_CLOSED_MISSING_OR_UNVERIFIED",
          "detail": "no value printed is required before this gate can close. This package records the requirement only.",
          "ownerAction": "Provide real owner/manual evidence later."
        }
      ]
    },
    {
      ...
      "rows": [
        {
          "area": "no connection test in this package",
          "status": "LOCKED",
          "detail": "no connection test in this package remains blocked or future-only until owner/manual evidence exists.",
          "ownerAction": "Do not mark this complete automatically."
        },
        {
          "area": "no production DB writes",
          "status": "LOCKED",
          "detail": "no production DB writes remains blocked or future-only until owner/manual evidence exists.",
          "ownerAction": "Do not mark this complete automatically."
        }
      ]
    }
...
export function getAphroditeDatabaseUrlClosureCandidate() {
  return aphroditeDatabaseUrlClosureCandidate;
}
